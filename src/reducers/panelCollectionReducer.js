...
export const _initialPanelCollection = (function () {
  ...
  const panelCollection = {
    ...
    events: [
      {
        timestamp: moment().add(0, 'days').hour(18).minute(12).second(0),
        type: 'disable',
        summary: 'Print the documents.'
      },
      {
        timestamp: moment().add(1, 'days').hour(8).minute(39).second(0), // a moment representing Yesterday at 8:39:00 AM
        type: 'disable',
        summary: 'Start the dishwasher.'
      },
      {
        timestamp: moment().add(2, 'days').hour(13).minute(21).second(0),
        type: 'disable',
        summary: 'Do the laundary.'
      }
    ]
  };
